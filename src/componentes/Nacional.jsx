...
// Función para obtener miniatura de Google Drive
    ...
    onValue(nationalNewsRef, (snapshot) => {
      ...
      const newsArray = data
        ? Object.entries(data)
            ...
            .filter((item) => item.category === 'NACIONAL' || (item.category && item.category.includes('NACIONAL')))
        : [];
    ...
    <div>
      ...
      <div className='mt-4'>
        {currentNews.map((item) => {
          ...
          // Determinar miniatura del video
          let thumbnail = null;
          if (videoUrl) {
              ...
              <div className="news-card">
                <MDBCard className='mb-3'>
                  <MDBRow className='g-0'>
                    ...
                    <MDBCol md='7'>
                      <MDBCardBody>
                        <MDBBadge color='primary' pill>NACIONAL</MDBBadge>
